...
app.config["SQLALCHEMY_DATABASE_URI"] = 'mysql://root:''@localhost/deteksimerokok'
app.config["SQLALCHEMY_TRACK_MODIFICATIONS"] = False
app.config["SQLALCHEMY_ECHO"] = True

app.config['SECRET_KEY'] = 'jonoseduhkopi'
...
# def visualisasi():
#     return render_template("tampilan/visualisasi/visualisasi.html")
...
if __name__ == '__main__':
    ...
    # app.run(debug=True)
    app.run(host='192.168.71.203', port=5000, debug=False)